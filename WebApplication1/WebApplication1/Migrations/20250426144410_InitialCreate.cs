        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceOffers_AutoServices_AutoServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_ServiceOffers_ServiceOfferId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppointmentHistoryId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AppointmentId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ServiceOfferId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOffers_AutoServiceId",
                table: "ServiceOffers",
