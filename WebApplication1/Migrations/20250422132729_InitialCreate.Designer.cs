...
namespace AutoServiceApi.Migrations
{
    ...
    [Migration("20250422132729_InitialCreate")]
            ...
            modelBuilder.Entity("WebApplication1.AutoServiceApi.Models.ServiceOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Основные",
                            CreatedDate = new DateTime(2025, 4, 22, 13, 27, 29, 89, DateTimeKind.Utc).AddTicks(1194),
                            DurationMinutes = 60,
                            IsActive = true,
                            Name = "Замена масла",
                            Price = 2000m
                        ...
                        new
                        {
                            Id = 2,
                            Category = "Основные",
                            CreatedDate = new DateTime(2025, 4, 22, 13, 27, 29, 89, DateTimeKind.Utc).AddTicks(1755),
                            DurationMinutes = 60,
                            IsActive = true,
                            Name = "Диагностика",
                            Price = 1500m
