    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "ул. Примерная, 123", "Автосервис Косованова", "+7 (123) 456-78-90" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Полная замена моторного масла и фильтра", "Замена масла", 2000m },
                    { 2, "Компьютерная диагностика автомобиля", "Диагностика", 1500m }
                });
